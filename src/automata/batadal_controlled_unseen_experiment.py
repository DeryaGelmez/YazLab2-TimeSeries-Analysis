...
def main():
    ...
    print("BATADAL Kontrollü Unseen Deneyi Başladı")
    ...
    controlled_test_patterns = (
        create_controlled_unseen_test_patterns(
    ...
    print("\nToplam test pattern sayısı:",
          len(controlled_test_patterns))

    print("Kontrollü unseen pattern sayısı:",
          len(unseen_records))
    ...
    unseen_output_path = (
        LOGS_DIR /
        "batadal_controlled_unseen_mapping.csv"
    )
    ...
    result_output_path = (
        LOGS_DIR /
        "batadal_controlled_unseen_results.csv"
    )
